...
class AlexNet(nn.Module):   
    def __init__(self, num=10):
        ...
        self.feature = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            # As per the assignment instructions, next MaxPool2d should be applied with kernel_size = 2 & stride = 2.
            # However, that will not result in output of desired size of 32*12*12 but instead in output of size 32*6*6.
            # To achieve output of size 32*12*12, MaxPool2d should be run with stride = 1 instead.
