...
if __name__ == '__main__':
    ...
    print("Initial MSE: ", 2 * mse_cost_func(y, hypothesis(x1, x2, w0, w1, w2)))
    y_pred, new_mse = gradient_descent(x1, x2, y, w0, w1, w2, alpha, iter)
    print("Final prediction of y: ", y_pred)
    print("Final MSE: ", 2 * new_mse)
